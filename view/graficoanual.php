...
$sql ="SELECT CONCAT(b.nom_usu,' ',b.pat_usu,' ',b.mat_usu) as Trabajador, COUNT(a.cod_sct) as Ingresos FROM escrituras1 AS a, usuarios AS b WHERE  a.hra_ing between '".$year."-01-01 00:00:00' and '".$year."-12-31 23:59:59' AND a.cod_usu = b.cod_usu AND b.chk_usu =1  GROUP BY a.cod_usu;";


    //mysqli_set_charset($conexion, "utf8"); //formato de datos utf8
if(!$result = $link->query($sql)) die(); //si la conexión cancelar programa
    ...
    <meta charset="UTF-8">
        ...
        <script type="text/javascript">
            ...
            AmCharts.ready(function () {
                ...
                chart.categoryField = "Trabajador";
                chart.color = "#000";
                chart.fontSize = 10;
    ...
    <body>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Gráfico por Grupo de Indexadores</h2>
                        ...
                        <!-- jQuery -->
                            ...
                            <script src="../js/plugins/flot/flot-data.js"></script>
                                <h3>Administrador del Sistema  - Reporte Anual</h3>
