...
if($fec_fin == ""){
   $sql = "SELECT hra_ing,cod_usu,cod_sct,num_sct FROM escrituras1  WHERE hra_ing LIKE '$fec_ini%' AND cod_usu LIKE '$cod_usu' ORDER BY hra_ing";
   ...
   $query = mysql_query($sql);
      ...
      $query = mysql_query($sql);
	   ...
	   $sql = "SELECT hra_ing,cod_usu,cod_sct,num_sct FROM escrituras1 WHERE hra_ing BETWEEN '$fec_ini 00:00:00' AND '$fec_fin 23:59:59' AND cod_usu LIKE '$cod_usu' ORDER BY hra_ing";
     $query = mysql_query($sql);
   	}
}
?>
