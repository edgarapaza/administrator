...
if(!$personal == 0){
    ...
    $sql ="SELECT MONTH(hra_ing) AS Mes, COUNT(cod_sct) AS Ingresos FROM escrituras1 WHERE cod_usu = $personal AND hra_ing between '".$year."-01-01 00:00:00' AND '".$year."-12-31 23:59:59' GROUP BY (MONTH(hra_ing));";
...
<head>
    <meta charset="UTF-8">
        ...
        <title>Grafico por Persona</title>
    ...
    <body>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Gráficos Individuales por Trabajador</h2>
                        ...
                        <!-- jQuery -->
                            ...
                            <script src="../js/plugins/flot/flot-data.js"></script>
                                <h3>Administrador del Sistema  - Reporte Individual <?php echo $year;?></h3>
                                ...
                                <form action="">
                                    ...
                                    <select name="personal" id="personal">
                                        <option value="0">[Seleccione Usuario a mostrar]</option>

                                        <?php
                                            $sqlPersonal = "SELECT cod_usu , CONCAT(nom_usu,' ',pat_usu,' ',mat_usu) as trabajador FROM usuarios WHERE chk_usu = 1;";
                                            $resultPersonal = $link->query($sqlPersonal);
                                            while($fila = $resultPersonal->fetch_assoc()){
                                        ?>
