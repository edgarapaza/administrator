...
$cod_otorgante_juridica = $_REQUEST['cod_otorgante_juridica'];
...
print "<meta http-equiv=Refresh content=\"0 ; url=../View/Personal/ingreso.php?codigo_otorgante=".$cod_otorgante_juridica."&codigo_favorecido=".$cod_inv_juridicas."\">";
