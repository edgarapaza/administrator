...
<form name="otorgantes" method="post" action="">
  <table width="664" height="119" border="0">
  	<caption>Buscar por el Favorecido (Comprador)<input type="button" class="boton" name="regresar" value="Salir" onclick="javascript:location.href='./index_old.php'" /></caption>
    <tr>
