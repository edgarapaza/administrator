...
//
                ...
                <form action="" method="post" enctype="multipart/form-data" name="involucrados" id="involucrados">
                    <table width="755" height="263" border="0" background="../imagenes/fondo.jpg" align="center">
                        ...
                        <tr>
                            ...
                            <td width="120" height="35" align="left"><span class="style15">Otorgante</span></td>
        <?php
        ...
        ?>
                        ...
                        <tr>
                            ...
                            <td width="145" class="style15"><label>
                                    <input name="pro" type="text" id="pro" size="10" value="<?php echo $ver["Protocolo"]; ?>"/>
                                </label></td>
                            <td width="72" class="style15" align="right">N&ordm; Escritura</td>
                            <td width="77" class="style15"><label>
                                    <input name="sct" type="text" id="sct" size="10" value="<?php echo $ver["Escritura"]; ?>"/>
                                </label></td>
                            <td width="38" class="style15" align="right">Folio</td>
                            <td width="108" class="style15"><label>
                                    <input name="folio" type="text" id="folio" size="10" value="<?php echo $ver["Folio"]; ?>" />
                                </label></td>
                            <td width="92" class="style15" align="right">Cant.Folio</td>
                            <td width="64" class="style15"><label>
