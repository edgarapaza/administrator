...
//Obtener el Numero de Escritura
    $cod_fav = $_REQUEST['cod_favor'];
    echo $cod_fav;
    echo "<br>";
    $consult = "SELECT cod_rel FROM escrifavor1 WHERE cod_inv = $cod_fav";
...
//Obtener el Codigo del Favorecido
    $consult1 = "select cod_rel from escriotor1 where cod_sct = $cod_sct";
            ...
            <form action="" method="post" enctype="multipart/form-data" name="involucrados" id="involucrados">
                <table width="755" height="263" border="0" background="../imagenes/fondo.jpg" align="center">
                    ...
                    <tr>
                        <td align="left">&nbsp;</td>
                        <?php
                        $D = "SELECT CONCAT(nom_inv,' ',pat_inv,' ', mat_inv) AS favorecido, otros FROM involucrados1 WHERE cod_inv = $cod_fav";
                        $E = mysql_query($D);
