...
if (isset($_SESSION['personal'])) {
    ...
    $q1 = "select * from involucrados1 where cod_inv = $CodOtor";
    $r = mysql_query($q1);
    ...
    <html>
        ...
        <script language="javascript" type="text/javascript">
            ...
            if(materno == ""){
                ...
                if(confirm("Estas Seguro de Agregar este Otorgante?")){
                   involucrados.submit();
                        return true;
                }
                else
        ...
        <body>
            ...
            <form action="../../Model/involucrado_update.php" method="post" enctype="multipart/form-data" name="involucrados" id="involucrados">
                <p align="center" class="error">Agregar a: OTORGANTE</p>
                <div align="center">
                    <table width="574" border="1" cellpadding="1" cellspacing="4" bgcolor="#2F3962">
                        ...
                        <tr><input type="hidden" name="codigo_otor" id="codigo_otor" value="<?php echo  $DatPer["codigo"] ?>" />
