...
//Obtener el Numero de Escritura
    ...
    if ($cod_favor == "") {
        header("Location: ../buscar_otor_detail.php?error=No tiene favorecido");
        exit();
    } else {
...
//
                ...
                <form action="" method="post" enctype="multipart/form-data" name="involucrados" id="involucrados">
                    <table width="755" height="263" border="0" background="../imagenes/fondo.jpg" align="center">
                        ...
                        <tr>
                            ...
                            <td width="108" height="35" align="left"><span class="style15">Otorgante</span></td>
        <?php
        $R = "SELECT Raz_inv, otros_juri FROM involjuridicas1 WHERE cod_inv = $cod_otor";
        $Q = mysql_query($R);
        ...
        ?>
                        ...
                        <tr>
                            ...
                            <td align="left"><span class="style15">Sub Serie</span></td>
        <?php
        $Sr = $ver["SubSerie"];
        ...
        ?>
                            <td colspan="5" class="style15"><input name="notario" type="text" id="notario" size="70" value="<?php echo $nto[0]; ?>" />
                                Distrito
