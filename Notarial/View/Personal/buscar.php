...
if (isset($_SESSION['personal'])) {
    ...
    while (@$fila = mysql_fetch_array($result)) {
        ?>
                        <tr>   
                            <td align="center">
                                <input type="hidden" name="cod_not" id="cod_not" value="<?php echo $fila[0]; ?>" readonly />
                                <input type="text" name="nom_not" id="nom_not" value="<?php echo $fila[1]; ?>" readonly /></td>
                            <td align="center"><input type="text" name="pat_not" id="pat_not" value="<?php echo $fila[2]; ?>" readonly /></td>
                            <td align="center"><input type="text" name="mat_not" id="mat_not" value="<?php echo $fila[3]; ?>" readonly /></td>
                            <td width="62" align="center">
                                <a href="ingreso.php?cod_not=<?php echo $fila[0]; ?>&nom_not=<?php echo $fila[3]; ?> <?php echo $fila[2]; ?> <?php echo $fila[1]; ?>">Mandar</a>
