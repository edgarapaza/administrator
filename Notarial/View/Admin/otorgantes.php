...
<body>
  <table width="1055" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="600" rowspan="2"><img src="../imagenes/Banner2.jpg" width="600" height="100" /></td>
...
<div align="center" id="titulo"><img src="../imagenes/OTORGANTE.jpg" width="400" height="32" /></div>
  <div align="left"></div>
<form action="" method="post" enctype="multipart/form-data" name="involucrados" id="involucrados">
  <div align="center">
    <table width="698" border="1" cellpadding="1" cellspacing="4" bgcolor="#006699">
      <tr>
        ...
        if(isset($_POST[btnbuscar]))
 	{
        ...
        ?></td>
        <td>
          <input type="button" class="boton" name="btnNuevo1" id="btnNuevo1" value="Nuevo Otorgante" onclick="javascript:location.href = './add_involucrado.php?nombres=<?=$nombres?>&paterno=<?=$paterno?>&materno=<?=$materno?>'"/>
        </td>
      </tr>
    </table>
    ...
    ?>
      <tr>
        ...
        <td width="218" bgcolor="#FDFECB"><a href="favorecidos.php?codigo_otorgante=<?=$fila4[0];?>">SELECCIONAR</a></td>
      </tr>
      <?
    }
    ?>
  ...
  <div align="center">
    ...
    <tr>
      ...
      <tr>
        ...
        ?>
          <input type="button" class="boton" name="btnNuevo2" id="btnNuevo2" value="Nuevo Otorgante" onclick="javascript:location.href='./add_invol_juridica.php'"/></td>
      </tr>
      <?
	...
	?>
      <tr>
        <td bgcolor="#D5E4FD"><input type="hidden" name="cod_otor_juridica" id="cod_otor_juridica" value="<?=$fila2[0];?>" readonly="readonly" />
          <?=$fila2[1];?></td>
        <td bgcolor="#FDFECB"><a href="favorecidos.php?codigo_otorgante=<?=$fila2[0];?>">SELECCIONAR</a><a href="favorecidos.php"></a></td>
      </tr>
