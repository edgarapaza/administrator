    ...
    ?>
        ...
        ?>
                        ...
                        <tfoot>
                            ...
                            <?php
                            if ($pagina > 1) {
                                echo "<a href='" . $_SERVER["PHP_SELF"] . "?pagina=" . ($pagina - 1) . "&orden=" . $orden . "&nombres=" . $nombres . "'>";
                                echo "Anterior";
                                echo "</a> ";
                            }
                            ...
                            for ($i = $inicio; $i <= $final; $i++) {
                                if ($i == $pagina) {
                                    ...
                                    echo "<a href='" . $_SERVER["PHP_SELF"] . "?pagina=" . $i . "&orden=" . $orden . "&nombres=" . $nombres . "&paterno=" . $paterno . "&materno=" . $materno . "'>";
                                    echo $i . "</a> ";
                                }
                            }
                            if ($pagina < $numPags) {
