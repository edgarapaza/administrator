...
if (isset($_SESSION['busqueda'])) {
    ...
    require_once 'Model/buscarclassold.php';
        ...
        <head>
            ...
            <script language="javascript" type="text/javascript">
                function muestra(codigo, nombre){
                    location.href="buscar_otor_detail.php?cod_otor="+ codigo +"&nombre="+ nombre +"";
                }
            </script>
        </head>
        ...
        <body>
            ...
            <div id="datos">
                <form name="otorgantes" method="post" action="">
                    <table width="664" height="119" border="0">
                        <caption>Buscar por el Otorgante (Vendedor)<input type="button" class="boton" name="regresar" value="Salir" onclick="javascript:location.href='./index_old.php'" /></caption>
                        <tr>
                    ...
                    <div id="otros">
                        <table width="531" class="otros_datos">
                            <tr>
                                <td>&nbsp;</td>
                                <td >Día</td>
                                <td >Mes</td>
                ...
                <div id="cuerpo">
                    <table width="750" class="vista_datos">
