      ...
      <form id="form1" name="form1" method="post" action="Juridicos.php">
          <div class="formulario">
              <ul>
                ...
                <li> <label for="razonsocial">Razon Social:</label> <input name="razonsocial" type="text" id="nombres" value="<?php echo $datos['Raz_inv'];?>" size="255" /> </li>
                
                <li> <button class="submit" type="submit" name="btnGuardar" value="Guardar Cambios" onclick="javascript:window.close();">Guardar Cambios</button>
              </ul>
          </div>
      </form>
  </div>
